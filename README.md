...
## Acknowledgments
- The audio files used in this app were acquired from [freesound.org](https://freesound.org). All of them are in the public domain.
- The PWA icon for this icon was acquired from [freesvg.org](https://freesvg.org). The icon is also in the public domain.
